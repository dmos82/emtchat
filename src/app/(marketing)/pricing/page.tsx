...
const plans = [
  {
    ...
    features: [
      ...
      'Basic AI chat',
      'System knowledge base access',
    ],
    notIncluded: ['Document upload', 'Search', 'Export', 'Personas'],
  },
  {
    id: 'starter',
    name: 'Starter',
...
const enterprisePlan = {
  id: 'enterprise',
  name: 'Enterprise',
  description: 'Custom solutions for large organizations. Contact admin@emtchat.com',
  features: [
    'Unlimited queries',
    'Unlimited storage',
    '500MB max file size',
...
const featureComparison = [
  { feature: 'Monthly Queries', free: '10', starter: '200', pro: '1,000', team: '10,000', enterprise: 'Unlimited' },
  { feature: 'Storage', free: 'None', starter: '512 MB', pro: '2 GB', team: '20 GB', enterprise: 'Unlimited' },
  { feature: 'Max Documents', free: 'None', starter: '20', pro: '50', team: '150', enterprise: 'Unlimited' },
  { feature: 'Max File Size', free: 'None', starter: '25 MB', pro: '300 MB', team: '500 MB', enterprise: '500 MB' },
  { feature: 'Document Upload', free: false, starter: true, pro: true, team: true, enterprise: true },
  { feature: 'Search & Export', free: false, starter: true, pro: true, team: true, enterprise: true },
  { feature: 'Personas', free: false, starter: false, pro: true, team: true, enterprise: true },
  { feature: 'Priority Support', free: false, starter: false, pro: true, team: true, enterprise: true },
  { feature: 'Seats', free: '1', starter: '1', pro: '1', team: '15', enterprise: 'Unlimited' },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              ...
              },
              {
                ...
                a: 'Yes! Our Free tier gives you 10 queries per month permanently - no credit card required. Upgrade anytime when you need more.',
              },
              {
