/**
 * Help Content Registry for EMTChat
 *
...
export const helpContent: Record<string, HelpItem> = {
  ...
  'sidebar-feedback': {
    ...
    description: 'Share your thoughts, report bugs, or suggest improvements. Your feedback helps us make EMTChat better.',
    category: 'navigation',
  },
  ...
  'docs-search': {
    title: 'Filter Files',
    description: 'Filter files by filename. Type to filter the list in real-time.',
    category: 'documents',
  },
  'docs-preview': {
