          ...
          <div className="flex items-center gap-1">
            ...
            {message.modelUsed && (
              <button
                ...
                className="inline-flex items-center text-xs text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
              ...
              >
                ...
                />
                {showModel && (
                  <span className="ml-0.5 text-gray-500 dark:text-gray-400">
                    {message.modelUsed}
                  </span>
                )}
              </button>
