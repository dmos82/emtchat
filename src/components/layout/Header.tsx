...
export const Header: React.FC<HeaderProps> = () => {
  ...
  return (
    <header className="hidden md:flex h-[48px] bg-background-light border-b border-border-light items-center justify-between px-4 flex-shrink-0 shadow-sm z-10">
      {/* Logo / Brand */}
      <span className="font-semibold text-lg text-text-primary-light">EMTChat</span>
